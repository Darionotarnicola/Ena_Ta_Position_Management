sap.ui.define([
...
], function (BaseController, JSONModel, ModelManager, ApprovalManager) {
    "use strict";
    ...
    var oHome = {
        ...
        onPressTile: function () {
            this.navTo("RoutePreFilterPage");
        },
        onPressApproval: function () {
            var sFunction = "_PrepareListOfPositions"
            ApprovalManager._PrepareListOfPositions(sFunction).then(function () {
